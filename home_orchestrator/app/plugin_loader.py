...
PLUGIN_CATALOG = {
    "battery": {
        ...
        "downloadable": True,
        "tag": "v0.77.7",
        "sha256": "1af38538f3e8685607011db345ee85f5515c534eda60939e116712cc6996316b",  # sha256 real del tarball de v0.77.7, verificado contra una descarga real antes de fijarlo aqui (monotonic_sensor rechaza saltos imposibles entre ciclos, ademas del backfill con historico insuficiente de v0.77.6)
        "files": [
    ...
    "climate": {
        ...
        "version": "0.6.0",  # version PROPIA del plugin (ClimatePlugin.version) -- distinta de "tag", que es la version del REPO de la que se descarga
        "downloadable": True,
        "tag": "v0.77.8",
        "sha256": "3df57ae4e409b8a12d1fd8e28d77fffc101d58b273361b9b424b0bca34e79a09",  # sha256 real del tarball de v0.77.8, verificado contra una descarga real antes de fijarlo aqui (extractor independiente de temperatura + exposicion a HA opcional)
