...
PLUGIN_CATALOG = {
    "battery": {
        ...
        "downloadable": True,
        "tag": "v0.77.24",
        "sha256": "e6f2b86e4e9e571268f1488c710b3a9176def7382b5f2c039a78537e8144c773",  # sha256 real del tarball de v0.77.24, verificado contra una descarga real antes de fijarlo aqui (QA adversarial Fase 3: days_of_week, config no numerica, config.json corrupto, migracion legacy_id, logging asimetrico)
        "files": [
    ...
    "climate": {
        ...
        "version": "0.7.4",  # version PROPIA del plugin (ClimatePlugin.version) -- distinta de "tag", que es la version del REPO de la que se descarga
        "downloadable": True,
        "tag": "v0.77.31",
        "sha256": "8f55191690cc4c85191c2ed2a11066376a1d6c9ba582b5785d0c49f78dd93f31",  # sha256 real del tarball de v0.77.31, verificado contra una descarga real antes de fijarlo aqui (debounce del delegado climate.*, respeto a un cambio manual del actuador)
    ...
    "tplink": {
        ...
        "downloadable": True,
        "tag": "v0.77.32",
        "sha256": "e1fe0c37119d5cf3fc2f5da12327acc3409d3dcc8d4c0bdee125035c54b0159d",  # sha256 real del tarball de v0.77.32, verificado contra una descarga real antes de fijarlo aqui (el escaneo periodico ya no abre segunda sesion KLAP contra un dispositivo ya conectado)
