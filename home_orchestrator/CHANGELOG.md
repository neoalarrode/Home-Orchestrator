...
- Ordenes a baterias: una orden identica o de potencia casi igual ya no se reenvia cada 60 s (en simulacion, las llamadas a HA bajan aproximadamente a la mitad).
...
- Si el envio de una orden a una bateria falla (o EcoFlow no la confirma), se reintenta en el ciclo siguiente en vez de dar la orden por enviada. Las ordenes iguales se reafirman cada 2 minutos y las reducciones de potencia se reenvian con una tolerancia mas estrecha (10 W o 2 %).
